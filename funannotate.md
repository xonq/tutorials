...
## OSC USE
#### Accessing GeneMark
Accept the license (topaz.gatech.edu/GeneMark/license_download.cgi), download a key, and transfer to your home directory as `~/.gm_key`. These expire in 400 days and will cause GeneMark errors.
