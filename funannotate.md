...
- find the most closely related BUSCO species database `/fs/project/PAS1046/databases/busco/config/`. Replace `BUSCO_SPECIES` below with the name of the BUSCO species parameter folder.
